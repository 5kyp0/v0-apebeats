/**
 * Simplified LoFi Generator Tests
 * 
 * Basic tests for LoFi music generation functionality
 */
...
describe('LoFiHipHopGenerator - Basic Tests', () => {
  ...
  describe('Basic Music Generation', () => {
    it('should generate music with valid blockchain data', async () => {
    ...
    it('should create LoFi-specific music parameters', async () => {
      ...
      expect(params.octaveRange).toEqual([3, 6]);
      expect(params.volume).toBeLessThan(0.6);
      expect(params.reverb).toBeGreaterThan(0.3);
      expect(params.distortion).toBeLessThan(0.2);
    });
      ...
      const differentData = [
        {
          ...
          gasPrice: '50000000000', // Much higher gas price
