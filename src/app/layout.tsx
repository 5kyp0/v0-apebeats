...
import GlyphProvider from "@/components/providers/GlyphProvider"
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              document.addEventListener('DOMContentLoaded', function() {
                // Helper function to check if element has closest method
                ...
                document.addEventListener('contextmenu', function(e) {
                  if (hasClosest(e.target) && e.target.closest('.genesis-protected')) {
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
                  }
