...
import { BarChart3, ArrowLeft, TrendingUp, Clock, CheckCircle } from "lucide-react"
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <Card className="border-2 border-dashed border-muted-foreground/30">
              <CardHeader>
                ...
                <CardDescription>
                  Track all your batch operations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  View detailed history of all your batch transfers, including transaction status, gas costs, and recipient counts.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-dashed border-muted-foreground/30">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Real-time updates on pending transactions with detailed status tracking and completion notifications.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-dashed border-muted-foreground/30">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Comprehensive analytics including total transfers, gas savings, success rates, and performance trends.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-dashed border-muted-foreground/30">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Generate and export detailed reports of your batch operations for accounting and record-keeping purposes.
                </p>
              </CardContent>
            </Card>
          </div>
